...
import "pose-capture";
import { PosePlayer, KeyframeEvent, BasePlayer } from "pose-capture";
import { PoseRecording, VideoPoseBase } from "pose-capture/videopose-element";
...
export class DemoApp extends LitElement {
    ...
    constructor() {
        ...
        this.addEventListener(KeyframeEvent.EventName, ((event: KeyframeEvent) => {
            ...
            if (part && this.coordsLog) {
                ...
                this.coordsLog.innerText = `${coords[0].toFixed(2)}, ${coords[1].toFixed(2)}, ${coords[2]?.toFixed(2) || 0}`;
            }
    ...
    renderPlayer() {
        switch (this.selected) {
            case 'bodypix':
                return html`
                    <bodypix-video 
                            ...
                            ?usecamera=${this.currentSource === 'camera'}
            ...
            case 'pose':
                return html`<pose-player id="player" autoplay src=${this.currentPoseFile} islooping>
                    <visualization-canvas dotcolor="#ff0000" dotbackcolor="#000000"></visualization-canvas>
                    <pose-playback-controls></pose-playback-controls>
                </pose-player>`;
